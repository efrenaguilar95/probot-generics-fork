import { createProbot, Probot, Options } from "../src/index.js";
import { captureLogOutput } from "./helpers/capture-log-output.js";
import { describe, expect, test } from "vitest";

class TestBot extends Probot {
    constructor(options: Options = {}) {
      console.log("TestBot constructor called!")
      super(options);
    }
  }
...
describe("createProbot", () => {
  test("createProbot()", () => {
    const probot = createProbot({ env }, TestBot);
